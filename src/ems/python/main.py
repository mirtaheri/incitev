    ...
    try:
        ...
        while(1):
            ...
            if(TEST_ADC):       # ADC Test
                ...
                #print((raw_voltage - rawcurrent)/0x80000000) 
                if(raw_voltage>>31 ==1):
                    voltage = REF*2 - raw_voltage * REF / 0x80000000
                    #print(voltage)   
                else:
                    voltage = REF*2 - raw_voltage * REF / 0x7fffffff  # 32bit
                print(voltage*60)
                if(rawcurrent>>31 ==1):
                    current = REF*2 - rawcurrent * REF / 0x80000000
                    
                else:
                    current = REF*2 - rawcurrent * REF / 0x7fffffff  # 32bit
                
                voltage = (voltage +1)* VOLTAGE_COEFF
